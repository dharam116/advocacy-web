            ...
            <Container>
              <Row>
                <Col md="4">
                  ...
                  <h2 style={{color: 'red'}}>Employment law</h2>
                ...
                <Col md="4" className="clearfix d-none d-md-block">
                  ...
                  <h2 style={{color: 'red'}}>Domestic violence</h2>
                ...
                <Col md="4" className="clearfix d-none d-md-block">
                  ...
                  <h2 style={{color: 'red'}}>Securities law</h2>
            ...
            <CarouselItem itemId="2">
              ...
              <Row>
                <Col md="4">
                  ...
                  <h2 style={{color: 'red'}}>Federal crimes</h2>
                ...
                <Col md="4" className="clearfix d-none d-md-block">
                  ...
                  <h2 style={{color: 'red'}}>Insurance Law</h2>
